...
const enhance = compose(
  withState('selectedPoint', 'setSelectedPoint', null),
  withState('selectedPointInformation', 'setSelectedPointInformation', null),
  withState('renderedPoints', 'setRenderedPoints', (props) => {
    console.log(props)
    return null
  }),
  withState('renderedTypes', 'setRenderedTypes', (props) => {
    console.log(props)
    return null
  }),
  withHandlers({
...
const TypeFilters = enhance(props => {
  const { type } = props
  let number = 0
...
const renderTypeFilter = (type, types, points) => {
  let number = 0
